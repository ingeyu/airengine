...
see http://msdn.microsoft.com/zh-cn/library/windows/desktop/ms724832.aspx
*/
...
//
class COMMON_EXPORT	CXWinVersion
{
// Construction
public:
	CXWinVersion()
...
public:
	...
	Air::AString	GetServicePackString()	{ return m_osinfo.szCSDVersion; }
	Air::AString	GetVistaProductString();
	DWORD			GetVistaProductType();
	int				GetWinVersion();
	Air::AString	GetWinVersionString();
	BOOL			IsWin95();
	BOOL			IsWin98();
	BOOL			IsWin2KorLater();
	BOOL			IsWin2003();
