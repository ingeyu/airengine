...
{
	BOOL	b	=	!m_wndFileView.IsVisible();
	m_wndFileView.ShowPane(b,FALSE,FALSE);
}


void CMainFrame::On32779()
{
	BOOL	b	=	!m_wndProperties.IsVisible();
	m_wndProperties.ShowPane(b,FALSE,FALSE);
}


void CMainFrame::On32780()
{
	BOOL	b	=	!m_wndOutput.IsVisible();
	m_wndOutput.ShowPane(b,FALSE,FALSE);
}

CTreeCtrl* CMainFrame::GetFileTreeCtrl()
{
	return	m_wndFileView.GetTreeCtrl();
}

CPropertiesWnd& CMainFrame::GetPropertyWindow()
{
