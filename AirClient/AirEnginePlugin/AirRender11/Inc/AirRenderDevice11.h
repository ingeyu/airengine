			...
			***/
			...
			public:
				...
				**/
				...
				virtual	void		SetRTV_DSV_UAV(U32	uiCount,void**	pRTV,void*	pDSV,U32 uiUAVStart,U32 uiUAVCount,void** pUAV,U32 uiUAVInitCount );
				virtual	void		SetUAV(U32	uiCount,void**	pUAV,U32 uiUAVInitCount );
